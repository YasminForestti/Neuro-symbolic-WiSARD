...
alfa_values = range(10, 1400,50)
for alfa in alfa_values: 
    for i in range(100):
        wisard = WiSARD(topologia_do_input, tuple_size= 6,  threshold = 0, regra = regras_bot, alfa = alfa) 
    ...
    df = pd.DataFrame({'Modelo': ['WiSARD com Regra'], 'Acurácia': [media], 'alpha': [alfa]})
